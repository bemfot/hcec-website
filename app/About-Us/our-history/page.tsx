        ...
        <div className="flex-1 flex justify-center items-start py-12 px-4 md:px-12">
          <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-2xl border-l-2 border-red-500">
            ...
            <div className="text-gray-700 text-justify text-lg leading-relaxed justify-center align-center">
              <p className="mb-3">
                The history of this church cannot be fully given in this
                booklet, but it can be briefly stated. The foundation of this
                Evangelical Church can be traced to seven (7) men who met
                frequently to pray for the revival which God promised all
                Christian Churches and to usher in the salvation of
                non-Christians. The seven afore-said Christian brothers started
                their spiritual life in one of the Pentecostal Churches in
                Nigeria, (The Redeemed Christian Church of God) which has its
                headquarters in Lagos. A local assembly of the church was at
                Ibadan where they were all converted. <br />
              </p>
              <p className="mb-3">
