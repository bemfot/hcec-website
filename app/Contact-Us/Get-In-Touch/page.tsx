    ...
    <div>
      ...
      <div className="pt-20 md:px-10 md:pt-24 pb-24 md:pb-5 bg-gray-800 shadow-lg min-h-screen">
        <div className="grid grid-cols-1 md:grid-cols-2 bg-black/60 min-h-screen">
          ...
          <div
            className="bg-gray-700 py-8
          text-white px-10 flex flex-col justify-center"
          >
            <h2 className="text-3xl font-bold mb-4">Contact Info</h2>
            <p className="mb-6">
              Whether you are just paying us a visit for the very first time, or
              you want to talk to us, or you have a prayer request, or you want
              to share your testimony, we are here for you. You can do so by
