...
export default function Testimony() {
  ...
  return (
    <div>
      {" "}
      <div className="md:px-10 md:pt-[2.8rem] md:pb-5  bg-gray-800 shadow-lg min-h-screen">
        <div className="grid grid-cols-1 md:grid-cols-2 mt-16  bg-black/60 min-h-screen">
