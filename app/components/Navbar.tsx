...
const defaultNavItems: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: "Prayer Requests", link: "Home-page/Prayer-RequestForm" },
    ],
  },
  {
    label: "ABOUT US",
  ...
  },
  {
    ...
    link: "#",
    children: [
      { label: "Our Audio & Video Resources", link: "/Media-Resources" },
    ],
  },
  {
    ...
    link: "#",
    children: [
      { label: "Gospel Hymnal", link: "#" },
      { label: "Honey From The Rock", link: "#" },
      { label: "Daily Honey", link: "#" },
    ],
  },
  { label: "OUR PROGRAMS", link: "/Upcoming-Programs" },
  {
